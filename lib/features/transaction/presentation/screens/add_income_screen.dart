...
class AddIncomeScreen extends ConsumerStatefulWidget{
  ...
  @override
  ConsumerState<AddIncomeScreen> createState() => AddIncomeScreenState();
}

class AddIncomeScreenState extends ConsumerState<AddIncomeScreen>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Add Income", style : TextStyle(color: Colors.white, fontSize: 16)),
